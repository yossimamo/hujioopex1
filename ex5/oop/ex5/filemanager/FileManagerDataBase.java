...
public class FileManagerDataBase extends AbstractDataBase {
	...
	public FileManagerDataBase(String serverListFile, String directory, int port) {
	...
	private void initServers(String serverListFile) {
		...
		try {
			...
			//we assume input is legal so shouldn't happen.
		}
	...
	private void processLine(String nextLine) {
		...
		String IP = sc.next();
		//TODO check if needed i think localhost if fine.
		int port = sc.nextInt();
