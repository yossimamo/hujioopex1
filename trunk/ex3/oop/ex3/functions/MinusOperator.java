...
// DESCRIPTION: this class is an operator which subtract the second number
...
/**
 * this class is an operator which subtract the second number
 * in the input from the first number in the input.
...
public class MinusOperator extends Operator {
	...
	/**
	 * constructs a new minus operator. 
	 */
	...
	/**
	 * calculates the first number in the input minus the second one.
	 ...
	 * @return the first number in the input minus the second one.
	 */
